...
<head>
    ...
    <meta name="description"
        content="Discover the secrets of {city_name} with StoryHunt. An interactive urban adventure through the city's coolest neighborhoods. Mystery walks and hidden gems.">
    <meta name="keywords"
        content="{city_name}, {city_name} walk, StoryHunt, interactive adventure, hidden gems {city_name}, {city_name} mystery game">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://storyhuntweb.vercel.app/explore/{city_id}.html">
    <meta property="og:title" content="The {city_name} Secret Society | StoryHunt Interactive Adventure">

    <title>{city_name} Mystery | StoryHunt</title>
        ...
        <section class="hero" id="hero">
            <div class="container">
                <div class="glitch-wrapper">
                    <h1 class="glitch reveal-text" data-text="Decode {city_name}.">Decode {city_name}.</h1>
                </div>
                <p class="subtitle reveal-text">Warehouse parties aren't the only secrets here. The hunt explores the heart of {city_name}.</p>
                ...
                <div class="hero-actions reveal-text" style="--d: 0.8s">
                    <a href="#cta" class="primary-btn mono">
                        <span class="btn-text">JOIN_THE_HUNT_IN_{city_name_upper}</span>
...
def generate_pages():
    ...
    for city in set(CITIES):
        city_id = city.lower().replace(" ", "-").replace("'", "")
        city_name_upper = city.upper().replace(" ", "_").replace("'", "")
        
        file_name = f"{city_id}.html"
        file_path = os.path.join(output_dir, file_name)
        
        content = TEMPLATE.format(
            city_name=city,
            city_id=city_id,
            city_name_upper=city_name_upper
        )
